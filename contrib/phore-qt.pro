...
RESOURCES += src/qt/mano.qrc src/qt/mano_locale.qrc

TRANSLATIONS += src/qt/locale/mano_bg.ts \
                src/qt/locale/mano_de.ts \
                src/qt/locale/mano_en.ts \
                src/qt/locale/mano_es.ts \
                src/qt/locale/mano_fi.ts \
                src/qt/locale/mano_fr.ts \
                src/qt/locale/mano_it.ts \
                src/qt/locale/mano_ja.ts \
                src/qt/locale/mano_pl.ts \
                src/qt/locale/mano_pt.ts \
                src/qt/locale/mano_ru.ts \
                src/qt/locale/mano_sk.ts \
                src/qt/locale/mano_sv.ts \
                src/qt/locale/mano_vi.ts \
                src/qt/locale/mano_zh_CN.ts \
                src/qt/locale/mano_zh_TW.ts
