...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mano_address\> \<monthly_payment_mano\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MANO, _12_ times over the course of a year totaling _24000_ MANO.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mano_address\> \<monthly_payment_mano\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MANO.
