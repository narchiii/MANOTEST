...
In order to support loading of multiple wallets in mano-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mano.cpp.
...
Changes to mano.cpp
----------------------
mano.cpp is the entry point into mano-qt, and as such, will require some minor modifications to provide hooks for
