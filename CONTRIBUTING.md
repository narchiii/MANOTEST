Contributing to MANO Core
============================

The MANO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MANO Core project, and is not to be
confused with overall MANO Network Protocol consensus changes.

Whether a pull request is merged into MANO Core rests with the project merge
...
Patches that change MANO consensus rules are considerably more involved than
...
Where a patch set proposes to change the MANO consensus, it must have been
...
The project leader is the release manager for each MANO Core release.
