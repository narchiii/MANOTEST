                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MANO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MANO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mano: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MANO Core"), this);
    aboutAction->setStatusTip(tr("Show information about MANO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MANO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MANO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MANO addresses"));
    ...
    openAction->setStatusTip(tr("Open a MANO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MANO Core help message to get a list with possible MANO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MANO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MANO network", "", count));
}
...
{
    QString strTitle = tr("MANO Core"); // default title
