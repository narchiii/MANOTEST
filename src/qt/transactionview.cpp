 ...
 */
    ...
    typeWidget->addItem(tr("Received Mano from zMano"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMano"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMano));
